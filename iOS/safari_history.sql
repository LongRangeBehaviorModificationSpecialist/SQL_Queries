SELECT
    ...
    'File: /private/var/mobile/Library/Safari/History.db' AS 'DatabaseFile',
    /* Location of data */
    'Table: history_items(id:' ||  history_items.id || '), Table: history_visits(id:' || history_visits.id || ')' AS 'DataSource'
