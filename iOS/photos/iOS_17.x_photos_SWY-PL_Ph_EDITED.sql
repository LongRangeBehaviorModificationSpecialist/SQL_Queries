...
*/
    ...
    '/private/var/mobile/Library/Photos/Libraries/Syndication.photoslibrary/database/Photos.sqlite' AS 'Database File',
    'Table: ZASSET(Z_PK: ' || ZASSET.Z_PK || ')' AS 'Data Source'
...
FROM ZASSET
    ...
    LEFT JOIN Z_28ASSETS ON
        ZASSET.Z_PK = Z_28ASSETS.Z_3ASSETS
...
ORDER BY ZADDITIONALASSETATTRIBUTES.ZORIGINALFILENAME ASC