...
SELECT
    ...
    ZDETECTEDFACE.ZASSETFORFACE AS 'ZDETECTEDFACE.ZASSETFORFACE',
    ...
    'Photos.sqlite; Table: ZASSET(Z_PK:' || ZASSET.Z_PK || ')' AS 'DataSource'
...
FROM ZASSET
    ...
    LEFT JOIN ZDETECTEDFACE ON ZDETECTEDFACE.ZASSETFORFACE = ZASSET.Z_PK
