...
SELECT
    ...
    ZADDITIONALASSETATTRIBUTES.Z_PK AS '006-ZADDITIONALASSETATTRIBUTES.Z_PK',
    ...
    -- [CMZCLDMASTMEDDATA.Z_PK = ZADDITIONALASSETATTRIBUTES&ZCLDMAST.ZMEDIAMETADATA]
    ...
    ZADDITIONALASSETATTRIBUTES.ZORIGINALASSETSUUID AS '021-ZADDITIONALASSETATTRIBUTES.ZORIGINALASSETSUUID',
    ZADDITIONALASSETATTRIBUTES.ZPUBLICGLOBALUUID AS '022-ZADDITIONALASSETATTRIBUTES.ZPUBLICGLOBALUUID',
    -- ZADDITIONALASSETATTRIBUTES.ZMASTERFINGERPRINT AS '023-ZADDITIONALASSETATTRIBUTES.ZMASTERFINGERPRINT',
    ZADDITIONALASSETATTRIBUTES.ZORIGINATINGASSETIDENTIFIER AS '024-ZADDITIONALASSETATTRIBUTES.ZORIGINATINGASSETIDENTIFIER',
    ...
    ZADDITIONALASSETATTRIBUTES.ZORIGINALFILENAME AS '028-ZADDITIONALASSETATTRIBUTES.ZORIGINALFILENAME',
    ZCLDMAST.ZORIGINALFILENAME AS '029-ZCLDMAST.ZORIGINALFILENAME',
    ZADDITIONALASSETATTRIBUTES.ZSYNDICATIONIDENTIFIER AS '030-ZADDITIONALASSETATTRIBUTES.ZSYNDICATIONIDENTIFIER',
    ...
    CASE ZADDITIONALASSETATTRIBUTES.ZDATECREATEDSOURCE
        ...
        ELSE 'Unknown Value: ' || ZADDITIONALASSETATTRIBUTES.ZDATECREATEDSOURCE || ''
    END AS '032-ZADDITIONALASSETATTRIBUTES.ZDATECREATEDSOURCE',
    ...
    ZADDITIONALASSETATTRIBUTES.ZTIMEZONENAME AS '036-ZADDITIONALASSETATTRIBUTES.ZTIMEZONENAME',
    ZADDITIONALASSETATTRIBUTES.ZTIMEZONEOFFSET AS '037-ZADDITIONALASSETATTRIBUTES.ZTIMEZONEOFFSET',
    ZADDITIONALASSETATTRIBUTES.ZINFERREDTIMEZONEOFFSET AS '038-ZADDITIONALASSETATTRIBUTES.ZINFERREDTIMEZONEOFFSET',
    ZADDITIONALASSETATTRIBUTES.ZEXIFTIMESTAMPSTRING AS '039-ZADDITIONALASSETATTRIBUTES.ZEXIFTIMESTAMPSTRING',
    ...
    ZADDITIONALASSETATTRIBUTES.ZADJUSTEDFINGERPRINT AS '042-ZADDITIONALASSETATTRIBUTES.ZADJUSTEDFINGERPRINT',
    ...
    CASE ZADDITIONALASSETATTRIBUTES.ZCAMERACAPTUREDEVICE
        WHEN 0 THEN '0 [Back Camera/Other]'
        WHEN 1 THEN '1 [Front Camera]'
        ELSE 'Unknown Value: ' || ZADDITIONALASSETATTRIBUTES.ZCAMERACAPTUREDEVICE || ''
    END AS '064-ZADDITIONALASSETATTRIBUTES.ZCAMERACAPTUREDEVICE',
    ...
    CASE ZADDITIONALASSETATTRIBUTES.ZIMPORTEDBY
        ...
        ELSE 'Unknown Value: ' || ZADDITIONALASSETATTRIBUTES.ZIMPORTEDBY || ''
    END AS '065-ZADDITIONALASSETATTRIBUTES.ZIMPORTEDBY',
    ...
    ZADDITIONALASSETATTRIBUTES.ZIMPORTEDBYBUNDLEIDENTIFIER AS '067-ZADDITIONALASSETATTRIBUTES.ZIMPORTEDBYBUNDLEIDENTIFIER',
    ZADDITIONALASSETATTRIBUTES.ZIMPORTEDBYDISPLAYNAME AS '068-ZADDITIONALASSETATTRIBUTES.ZIMPORTEDBYDISPLAYNAME',
    ...
    printf("%,d", ZADDITIONALASSETATTRIBUTES.ZORIGINALFILESIZE) AS '084-ZADDITIONALASSETATTRIBUTES.ZORIGINALFILESIZE(bytes)',
    ...
    ZADDITIONALASSETATTRIBUTES.ZIMPORTSESSIONID AS '103-ZADDITIONALASSETATTRIBUTES.ZIMPORTSESSIONID',

    datetime(ZADDITIONALASSETATTRIBUTES.ZALTERNATEIMPORTIMAGEDATE + 978307200, 'UNIXEPOCH') AS '104-ZADDITIONALASSETATTRIBUTES.ZALTERNATEIMPORTIMAGEDATE(UTC)',
    ...
    datetime(ZADDITIONALASSETATTRIBUTES.ZLASTUPLOADATTEMPTDATE + 978307200, 'UNIXEPOCH') AS '110-ZADDITIONALASSETATTRIBUTES.ZLASTUPLOADATTEMPTDATE(SWY)(UTC)',

    ZADDITIONALASSETATTRIBUTES.ZUPLOADATTEMPTS AS '111-ZADDITIONALASSETATTRIBUTES.ZUPLOADATTEMPTS',
    ...
    END AS '116-ZADDITIONALASSETATTRIBUTES.ZGPSHORIZONTALACCURACY',

    -- hex(ZASSET.ZLOCATIONDATA) AS '117-ZASSET.ZLOCATIONDATA(HEX)',
    -- ZADDITIONALASSETATTRIBUTES.ZREVERSELOCATIONDATA AS '118-ZADDITIONALASSETATTRIBUTES.ZREVERSELOCATIONDATA(Orig-Asset, HEX NSKeyed .plist)',
    ...
    END AS '119-ZADDITIONALASSETATTRIBUTES.ZSHIFTEDLOCATIONISVALID',

    ZADDITIONALASSETATTRIBUTES.ZSHIFTEDLOCATIONDATA AS '120-ZADDITIONALASSETATTRIBUTES.ZSHIFTEDLOCATIONDATA',
    ZADDITIONALASSETATTRIBUTES.ZLOCATIONHASH AS '121-ZADDITIONALASSETATTRIBUTES.ZLOCATIONHASH',
    ...
    ZADDITIONALASSETATTRIBUTES.ZMEDIAMETADATATYPE AS '123-ZADDITIONALASSETATTRIBUTES.ZMEDIAMETADATATYPE',
    ...
    END AS '130-ZADDITIONALASSETATTRIBUTES.ZORIGINALORIENTATION',
    ...
    CASE ZADDITIONALASSETATTRIBUTES.ZCLOUDKINDSUBTYPE
        ...
        WHEN 102 THEN '102 [Time-lapse Video]'
        WHEN 103 THEN '103 [Replay Screen Recording]'
        ELSE 'Unknown Value: ' || ZADDITIONALASSETATTRIBUTES.ZCLOUDKINDSUBTYPE || ''
    END AS '133-ZADDITIONALASSETATTRIBUTES.ZCLOUDKINDSUBTYPE',
    ...
    ZADDITIONALASSETATTRIBUTES.ZVIDEOCPDURATIONTIMESCALE AS '139-ZADDITIONALASSETATTRIBUTES.ZVIDEOCPDURATIONTIMESCALE',
    ZASSET.ZVIDEOCPVISIBILITYSTATE AS '140-ZASSET.ZVIDEOCPVISIBILITYSTATE',
    ZADDITIONALASSETATTRIBUTES.ZVIDEOCPDISPLAYVALUE AS '141-ZADDITIONALASSETATTRIBUTES.ZVIDEOCPDISPLAYVALUE',
    ZADDITIONALASSETATTRIBUTES.ZVIDEOCPDISPLAYTIMESCALE AS '142-ZADDITIONALASSETATTRIBUTES.ZVIDEOCPDISPLAYTIMESCALE',
    ...
    CASE ZADDITIONALASSETATTRIBUTES.ZCLOUDAVALANCHEPICKTYPE
        ...
        WHEN 32 THEN '32 [Still Testing]'
        WHEN 52 THEN '52 [Burst Asset Visible LPL]'
        ELSE 'Unknown Value: ' || ZADDITIONALASSETATTRIBUTES.ZCLOUDAVALANCHEPICKTYPE || ''
    END AS '157-ZADDITIONALASSETATTRIBUTES.ZCLOUDAVALANCHEPICKTYPE',

    CASE ZADDITIONALASSETATTRIBUTES.ZCLOUDRECOVERYSTATE
        WHEN 0 THEN '0 [Still Testing]'
        WHEN 1 THEN '1 [Still Testing]'
        ELSE 'Unknown Value: ' || ZADDITIONALASSETATTRIBUTES.ZCLOUDRECOVERYSTATE || ''
    END AS '158-ZADDITIONALASSETATTRIBUTES.ZCLOUDRECOVERYSTATE',

    ZADDITIONALASSETATTRIBUTES.ZCLOUDSTATERECOVERYATTEMPTSCOUNT AS '159-ZADDITIONALASSETATTRIBUTES.ZCLOUDSTATERECOVERYATTEMPTSCOUNT',
    ...
    ZADDITIONALASSETATTRIBUTES.ZDEFERREDPHOTOIDENTIFIER AS '162-ZADDITIONALASSETATTRIBUTES.ZDEFERREDPHOTOIDENTIFIER',
    ZADDITIONALASSETATTRIBUTES.ZDEFERREDPROCESSINGCANDIDATEOPTIONS AS '163-ZADDITIONALASSETATTRIBUTES.ZDEFERREDPROCESSINGCANDIDATEOPTIONS',
    ...
    -- [ZUNMADJ.ZASSETATTRIBUTES = ZADDITIONALASSETATTRIBUTES.Z_PK]
    ZUNMADJ.ZASSETATTRIBUTES AS '165-ZUNMADJ.ZASSETATTRIBUTES',
    -- [ZADDITIONALASSETATTRIBUTES.ZUNMANAGEDADJUSTMENT = ZUNMADJ.Z_PK]
    ZADDITIONALASSETATTRIBUTES.ZUNMANAGEDADJUSTMENT AS '166-ZADDITIONALASSETATTRIBUTES.ZUNMANAGEDADJUSTMENT',
    -- [ZUNMADJ.Z_PK = ZADDITIONALASSETATTRIBUTES.ZUNMANAGEDADJUSTMENT]
    ...
    ZADDITIONALASSETATTRIBUTES.ZEDITORBUNDLEID AS '171-ZADDITIONALASSETATTRIBUTES.ZEDITORBUNDLEID',
    ...
    ZADDITIONALASSETATTRIBUTES.ZMONTAGE AS '174-ZADDITIONALASSETATTRIBUTES.ZMONTAGE',
    ...
    CASE ZADDITIONALASSETATTRIBUTES.ZPTPTRASHEDSTATE
        ...
        ELSE 'Unknown Value: ' || ZADDITIONALASSETATTRIBUTES.ZPTPTRASHEDSTATE || ''
    END AS '188-ZADDITIONALASSETATTRIBUTES.ZPTPTRASHEDSTATE',
    ...
    ZADDITIONALASSETATTRIBUTES.ZPENDINGVIEWCOUNT AS '193-ZADDITIONALASSETATTRIBUTES.ZPENDINGVIEWCOUNT',
    ZADDITIONALASSETATTRIBUTES.ZVIEWCOUNT AS '194-ZADDITIONALASSETATTRIBUTES.ZVIEWCOUNT',
    ZADDITIONALASSETATTRIBUTES.ZPENDINGPLAYCOUNT AS '195-ZADDITIONALASSETATTRIBUTES.ZPENDINGPLAYCOUNT',
    ZADDITIONALASSETATTRIBUTES.ZPLAYCOUNT AS '196-ZADDITIONALASSETATTRIBUTES.ZPLAYCOUNT',
    ZADDITIONALASSETATTRIBUTES.ZPENDINGSHARECOUNT AS '197-ZADDITIONALASSETATTRIBUTES.ZPENDINGSHARECOUNT',
    ZADDITIONALASSETATTRIBUTES.ZSHARECOUNT AS '198-ZADDITIONALASSETATTRIBUTES.ZSHARECOUNT',

    datetime(ZASSET.ZLASTSHAREDDATE + 978307200, 'UNIXEPOCH') AS '199-ZASSET.ZLASTSHAREDDATE(UTC)',

    ZADDITIONALASSETATTRIBUTES.ZSHAREORIGINATOR AS '200-ZADDITIONALASSETATTRIBUTES.ZSHAREORIGINATOR',
    ...
    ZADDITIONALASSETATTRIBUTES.ZSYNDICATIONHISTORY AS '202-ZADDITIONALASSETATTRIBUTES.ZSYNDICATIONHISTORY',
    ...
    CASE ZADDITIONALASSETATTRIBUTES.ZALLOWEDFORANALYSIS
        ...
        ELSE 'Unknown Value: ' || ZADDITIONALASSETATTRIBUTES.ZALLOWEDFORANALYSIS || ''
    END AS '207-ZADDITIONALASSETATTRIBUTES.ZALLOWEDFORANALYSIS',

    ZADDITIONALASSETATTRIBUTES.ZSCENEANALYSISVERSION AS '208-ZADDITIONALASSETATTRIBUTES.ZSCENEANALYSISVERSION',

    CASE ZADDITIONALASSETATTRIBUTES.ZSCENEANALYSISISFROMPREVIEW
        WHEN 0 THEN '0 [No]'
        ELSE 'Unknown Value: ' || ZADDITIONALASSETATTRIBUTES.ZSCENEANALYSISISFROMPREVIEW || ''
    END AS '209-ZADDITIONALASSETATTRIBUTES.ZSCENEANALYSISISFROMPREVIEW',

    datetime(ZADDITIONALASSETATTRIBUTES.ZSCENEANALYSISTIMESTAMP + 978307200, 'UNIXEPOCH') AS '210-ZADDITIONALASSETATTRIBUTES.ZSCENEANALYSISTIMESTAMP(UTC)',
    ...
    CASE ZADDITIONALASSETATTRIBUTES.ZDESTINATIONASSETCOPYSTATE
        ...
        ELSE 'Unknown Value: ' || ZADDITIONALASSETATTRIBUTES.ZDESTINATIONASSETCOPYSTATE || ''
    END AS '212-ZADDITIONALASSETATTRIBUTES.ZDESTINATIONASSETCOPYSTATE',
    ...
    ZADDITIONALASSETATTRIBUTES.ZSOURCEASSETFORDUPLICATIONSCOPEIDENTIFIER AS '216-ZADDITIONALASSETATTRIBUTES.ZSOURCEASSETFORDUPLICATIONSCOPEIDENTIFIER',
    ZCLDMAST.ZSOURCEMASTERFORDUPLICATIONSCOPEIDENTIFIER AS '217-ZCLDMAST.ZSOURCEMASTERFORDUPLICATIONSCOPEIDENTIFIER',
    ZADDITIONALASSETATTRIBUTES.ZSOURCEASSETFORDUPLICATIONIDENTIFIER AS '218-ZADDITIONALASSETATTRIBUTES.ZSOURCEASSETFORDUPLICATIONIDENTIFIER',
    ...
    ZADDITIONALASSETATTRIBUTES.ZVARIATIONSUGGESTIONSTATES AS '222-ZADDITIONALASSETATTRIBUTES.ZVARIATIONSUGGESTIONSTATES',
    ...
    ZADDITIONALASSETATTRIBUTES.ZORIGINALHEIGHT AS '242-ZADDITIONALASSETATTRIBUTES.ZORIGINALHEIGHT',
    ZINTRESOU.ZUNORIENTEDHEIGHT AS '243-ZINTRESOU.ZUNORIENTEDHEIGHT',
    ZASSET.ZWIDTH AS '244-ZASSET.ZWIDTH',
    ZADDITIONALASSETATTRIBUTES.ZORIGINALWIDTH AS '245-ADDASSETATTR.ZORIGINALWIDTH',
    ...
    ZADDITIONALASSETATTRIBUTES.ZEMBEDDEDTHUMBNAILHEIGHT AS '249-ZADDITIONALASSETATTRIBUTES.ZEMBEDDEDTHUMBNAILHEIGHT',
    ZADDITIONALASSETATTRIBUTES.ZEMBEDDEDTHUMBNAILLENGTH AS '250-ZADDITIONALASSETATTRIBUTES.ZEMBEDDEDTHUMBNAILLENGTH',
    ZADDITIONALASSETATTRIBUTES.ZEMBEDDEDTHUMBNAILOFFSET AS '251-ZADDITIONALASSETATTRIBUTES.ZEMBEDDEDTHUMBNAILOFFSET',
    ZADDITIONALASSETATTRIBUTES.ZEMBEDDEDTHUMBNAILWIDTH AS '252-ZADDITIONALASSETATTRIBUTES.ZEMBEDDEDTHUMBNAILWIDTH',
    ...
    ZADDITIONALASSETATTRIBUTES.ZORIGINALRESOURCECHOICE AS '262-ZADDITIONALASSETATTRIBUTES.ZORIGINALRESOURCECHOICE',
    ZADDITIONALASSETATTRIBUTES.ZSPATIALOVERCAPTUREGROUPIDENTIFIER AS '263-ZADDITIONALASSETATTRIBUTES.ZSPATIALOVERCAPTUREGROUPIDENTIFIER',
    -- hex(ZADDITIONALASSETATTRIBUTES.ZOBJECTSALIENCYRECTSDATA) AS '264-ZADDITIONALASSETATTRIBUTES.ZOBJECTSALIENCYRECTSDATA(HEX NSKeyed .plist)',
    -- hex(ZADDITIONALASSETATTRIBUTES.ZORIGINALHASH) AS '265-ZADDITIONALASSETATTRIBUTES.ZORIGINALHASH(HEX)',
    ZADDITIONALASSETATTRIBUTES.ZPLACEANNOTATIONDATA AS '266-ZADDITIONALASSETATTRIBUTES.ZPLACEANNOTATIONDATA',
    ZADDITIONALASSETATTRIBUTES.ZDISTANCEIDENTITY AS '267-ZADDITIONALASSETATTRIBUTES.ZDISTANCEIDENTITY'


FROM ZASSET

    LEFT JOIN ZADDITIONALASSETATTRIBUTES ON ZADDITIONALASSETATTRIBUTES.Z_PK = ZASSET.ZADDITIONALATTRIBUTES
    LEFT JOIN ZEXTENDEDATTRIBUTES ZEXTATTR ON ZEXTATTR.Z_PK = ZASSET.ZEXTENDEDATTRIBUTES
    LEFT JOIN ZINTERNALRESOURCE ZINTRESOU ON ZINTRESOU.ZASSET = ZASSET.Z_PK
    LEFT JOIN ZSCENEPRINT ZSCENEP ON ZSCENEP.Z_PK = ZADDITIONALASSETATTRIBUTES.ZSCENEPRINT
    ...
    LEFT JOIN ZUNMANAGEDADJUSTMENT ZUNMADJ ON ZADDITIONALASSETATTRIBUTES.ZUNMANAGEDADJUSTMENT = ZUNMADJ.Z_PK
    ...
    LEFT JOIN ZCLOUDMASTERMEDIAMETADATA AAAZCLDMASTMedData ON AAAZCLDMASTMedData.Z_PK = ZADDITIONALASSETATTRIBUTES.ZMEDIAMETADATA
