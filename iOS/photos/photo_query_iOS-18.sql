...
SELECT
    ...
    datetime(ZASSET.ZDATECREATED + 978307200, 'UNIXEPOCH') AS 'DateTimeCreated(UTC)',
    datetime(ZASSET.ZMODIFICATIONDATE + 978307200, 'UNIXEPOCH') AS 'ModificationDateTime(UTC)',
    datetime(ZASSET.ZADDEDDATE + 978307200, 'UNIXEPOCH') AS 'DateTimeAdded(UTC)',
