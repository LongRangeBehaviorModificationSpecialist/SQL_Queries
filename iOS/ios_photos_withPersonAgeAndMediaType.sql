SELECT
    ...
    ZADDITIONALASSETATTRIBUTES.ZEXIFTIMESTAMPSTRING AS 'EXIF TimeStamp (UTC)',
    ...
    datetime(ZGENERICASSET.ZLASTSHAREDDATE + 978307200, 'UNIXEPOCH', 'localtime') AS 'Last Shared Date (Local)',
    datetime(ZGENERICASSET.ZMODIFICATIONDATE + 978307200, 'UNIXEPOCH') AS 'File Modification Date (UTC)',
    datetime(ZGENERICASSET.ZMODIFICATIONDATE + 978307200, 'UNIXEPOCH', 'localtime') AS 'File Modification Date (Local)',
    ...
    datetime(ZGENERICASSET.ZADJUSTMENTTIMESTAMP + 978307200, 'UNIXEPOCH', 'localtime') AS 'Adjustments Time Stamp (Local)',
