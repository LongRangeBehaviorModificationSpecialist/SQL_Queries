/*
Query copied from https://github.com/ScottKjr3347/iOS_store.cloudphotodb_Queries/blob/main/iOS14_storecloudphotodb_Query/iOS14_storecloudphotodb_Query_withRAWdata.txt
*/
...
SELECT
    ...
    CASE downloadQueue.resourceType
        ...
        ELSE downloadQueue.resourceType
    ...
    CASE idMapping.mappingState
        ...
        WHEN 2 THEN 'Unknown-2'
        ELSE idMapping.mappingState
    ...
    CASE idMapping.deleteDirection
        ...
        WHEN 2 THEN 'unknown-2'
        ELSE idMapping.deleteDirection
    ...
    CASE scopes.hasFetchedInitialSyncAnchor
        WHEN 1 THEN 'Yes-1'
        ELSE scopes.hasFetchedInitialSyncAnchor
...
ORDER BY 'RAW idMapping-addTimestamp'
