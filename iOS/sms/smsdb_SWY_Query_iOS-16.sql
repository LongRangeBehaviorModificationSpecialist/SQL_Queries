/*
Query copied from https://github.com/ScottKjr3347/iOS_sms.db_queries/blob/main/iOS16/iOS16_SWY_smsdb_Query.txt
*/
...
SELECT
    ...
    CASE
        WHEN message.date IS NULL THEN '0'
...
-- WHERE message.ROWID BETWEEN 1 AND 500
